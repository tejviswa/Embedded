...
void PORT_init(char port)
{
	switch(port)
	{
		case 0:RCC_AHB1ENR |=(0x01<<0);break;    //PORT A CLOCK
		case 1:RCC_AHB1ENR |=(0x01<<1);break;    //PORT B CLOCK
		case 2:RCC_AHB1ENR |=(0x01<<2);break;		 //PORT C CLOCK
	}
}
